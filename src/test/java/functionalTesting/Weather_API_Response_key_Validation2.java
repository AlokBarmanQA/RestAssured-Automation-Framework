...
public class Weather_API_Response_key_Validation2 {
	...
	public void getWeatherByCity() {
		...
		Assert.assertTrue(json.getString("coord"));
		...
		while(itr.hasNext()) {
			...
			try {
				...
				else if(key.equalsIgnoreCase("vsibility")) {
					Assert.assertTrue(true, "vsibility");
					System.out.println("Validate value of: " +key);
				}
